...
**📋 О боте:**
Nico™ — это Telegram-бот, который предоставляет актуальную информацию о Формуле-1, анализирует гонки, даёт прогнозы и отвечает на вопросы как настоящий гоночный инженер.

**🤖 Искусственный интеллект:**
• **Nex-N2-Pro** — основная модель (262K контекста, agentic thinking)
• **NVIDIA Nemotron 3 Ultra** — резервная модель

**📊 Технологический стек:**
• AI: OpenRouter (Nex + Nemotron)
• Данные: OpenF1 + RSS (10+ источников)
• Платформа: Telegram Bot API 10.0
• Язык: Python 3.10 / aiogram 3.x

**👨‍💻 RedRace Development:**
• Кими Райкконен — Product Owner, архитектор
• Франц Герман — Lead Engineer, AI-интеграция
...
**Товарные знаки:**
• RedRace™ и Nico™ — незарегистрированные товарные знаки RedRace Development
• OpenRouter™ — товарный знак OpenRouter
• NVIDIA™ и Nemotron™ — товарные знаки NVIDIA Corporation
• Telegram™ — товарный знак Telegram FZ-LLC
• Все упомянутые товарные знаки являются собственностью их законных владельцев

**Отказ от ответственности:**
Данный бот является неофициальным проектом и не связан с Formula One Group, FIA, командами или спонсорами. Информация предоставляется «как есть» без каких-либо гарантий.

**Политика обработки данных:**
• Бот не собирает персональные данные пользователей.
• История диалогов хранится локально в зашифрованном виде для улучшения качества ответов и может быть удалена по запросу (/clear).
• Данные не передаются третьим лицам.

**Контакты:**
• По вопросам работы бота: @Scanialove
• Баг-репорты: @Scanialove
• Коммерческие предложения: @Scanialove

**Команды Нико:**
• /start — запуск бота
• /standings — таблица чемпионата
• /next — следующая гонка
• /character — случайный персонаж
• /donate — поддержать проект
• /info — эта справка
• /help — помощь

#RedRace #NicoBot #F1 #AI #OpenSource
"""
